...
export const rolePermissions: Record<UserRole, string[]> = {
  ...
  "Organization Admin": ["dashboard", "po-dashboard", "backlog", "kanban", "sprints", "sprint-planner", "reschedule-assistant", "scrum-master-dashboard", "developer-dashboard", "qa-dashboard", "issues", "team", "dag", "cicd", "reports", "retrospective", "settings", "admin", "demo-scenarios", "handoff", "org-dashboard"],
};
